...
function Gradient(_ref) {
  var children = _ref.children,
    style = _ref.style,
    isAnimationDisabled = _ref.isAnimationDisabled;
...
function BlackCreateWalletButton(_ref2) {
  ...
  var createWallet = (0, _react.useCallback)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _yield$provider$reque, _yield$provider$reque2, address;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          _yield$provider$reque = _context.sent;
          _yield$provider$reque2 = _slicedToArray(_yield$provider$reque, 1);
          address = _yield$provider$reque2[0];
